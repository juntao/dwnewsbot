...
public abstract class BaseServletBak extends HttpServlet {

    protected static String page_access_token = "";

    protected static String zencoder_apikey = "";
    protected static String audio_bluemix_username = "";
    protected static String audio_bluemix_password = "";
    ...
    public static void sendReply (Object reply, String uid) throws Exception {
        if (reply == null) {
            return; // No action
        }
    ...
    public static String transcodeAudio (String orgUrl, String target_format, int sample_rate) {
    ...
    public static String speechToText (String url, String format) throws Exception {
    ...
    public static JSONArray createElements (List <String> titles, List <String> subtitles, List <String> image_urls, int num_of_buttons, List <String> button_titles, List <String> button_payloads) throws Exception {
        if (num_of_buttons > 3) {
            num_of_buttons = 3;
        }
